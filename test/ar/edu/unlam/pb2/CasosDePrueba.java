...
public class CasosDePrueba {
	...
	public void queSePuedaInstanciarOtroComestible() {
		...
		assertEquals(2.05, ((Carne) producto).getKilos(), 0.1);
	...
	public void queSePuedaInstanciarUnaIndumentaria() {
		Indumentaria producto = new Remera(5, "Basica", "XL", "Lacoste", "Azul", 2000.0);

		assertEquals("Basica", ((Remera) producto).getDescripcion());
	...
	public void queSePuedaGenerarUnaVenta() {
		...
		vital.ingresarProducto(new Zapatilla(7, "Diarias", "45", "Topper", "Blancas", 2500.0));
		vital.ingresarProducto(new Televisor(8, "3D", 75, 12, "LG", 500000.0));
		vital.ingresarProducto(new Remera(9, "Basica", "L", "Lacoste", "Azul", 2000.0));
		vital.ingresarProducto(new Remera(9, "Basica", "M", "Lacoste", "Roja", 2000.0));
		vital.ingresarProducto(new Remera(9, "Basica", "S", "Lacoste", "Roja", 2000.0));
		vital.ingresarProducto(new Galletitas(10, "Oreo", "05/05/2021", "30/03/2022", "Arcor", 150.0));
